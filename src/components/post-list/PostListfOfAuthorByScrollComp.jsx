...
const PostListfOfAuthorByScrollComp = ({username}) => {
  ...
  const getCardData = async () => {
    const res = await fetch(
      `${BASE_URL}${postsApiUrl}/getPostsByAuthor/${username}?page=${page}&size=${POST_LIMIT_SIZE}`
    );
...
export default PostListfOfAuthorByScrollComp